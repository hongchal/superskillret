...
```
/plugin marketplace add hongchal/superskillret
/plugin install superskillret@hongchal
/reload-plugins
```
...
python3 ~/.claude/plugins/cache/hongchal/superskillret/0.3.1/scripts/setup_cli.py
```
